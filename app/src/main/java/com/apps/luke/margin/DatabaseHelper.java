...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long createEvent(Event_Class event) {
    ...
    public long createUser(User_Class u)
    {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void createEventEntries(List<EventEntry_Class> eventEntries) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    //Fetching
    public List<Event_Class> getEventsBasedOnStatus(String event_status)
    {
        ...
        List<Event_Class> eList = new ArrayList<Event_Class>();
    ...
    public List<User_Class> searchUser(String input)
    {
        SQLiteDatabase db = this.getReadableDatabase();

        List<User_Class> tempList = new LinkedList<User_Class>();
    ...
    public User_Class getUser(int user_id)
    {
        User_Class returnUser = new User_Class();
    ...
    public EventEntry_Class getWinner(int event_id, int eventScore)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        EventEntry_Class winnerEntry = new EventEntry_Class();
    ...
    public void updateAllUserNames(List<User_Class> u)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        ContentValues cv = new ContentValues();
    ...
    public List<EventEntry_Class> getEventEntriesBasedOnEvent(int event_ID)
    {
        ...
        List<EventEntry_Class> eList = new ArrayList<EventEntry_Class>();
    ...
    public List<EventEntry_Class> getEntriesOfEvent(int event_id)
    {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public List<Event_Class> getAllEvents()
    {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public List<User_Class> getAllUsers()
    {
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        List<User_Class> eList = new ArrayList<User_Class>();
