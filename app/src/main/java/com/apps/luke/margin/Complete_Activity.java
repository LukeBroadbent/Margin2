...
public class Complete_Activity extends Activity {
    ...
    EventEntry_Class eventWinner;
    User_Class winningUser;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(Complete_Activity.this);
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(eventWinner == null) {
                            if (gv.getDatabase().finishEvent(currentEvent.Event_ID, finalScore)) {
                            ...
                            if (gv.getDatabase().finishEvent(currentEvent.Event_ID, finalScore)) {
                                ...
                                List<Event_Class> newE = gv.getDatabase().getEventsBasedOnStatus("C");
