...
public class Past_Activity extends Activity {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                for (int i = 0; i < eventList.size(); i++) {
                    if (eventList.get(i).getEvent_Name().equals(sEvents.getSelectedItem().toString())) {
                        ...
                        User_Class u = gv.getDatabase().getUser(winningUserId);
    ...
    public void buildTable(List<EventEntry_Class> entries)
    {
        ...
        TextView tvUserName = new TextView(Past_Activity.this);
        ...
        TextView tvMargin = new TextView(Past_Activity.this);
        ...
        {
            TableRow tr = new TableRow(Past_Activity.this);
            //OrderLines.get(x);
            //tr.setId(x);
            ...
            TextView tvUN = new TextView(Past_Activity.this);
            ...
            TextView tvMarg = new TextView(Past_Activity.this);
